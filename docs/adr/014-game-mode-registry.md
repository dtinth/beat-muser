...
**Status:** Accepted (extended by ADR 020)
...
- The nanostore subscription makes registration reactive — no manual refresh calls needed from extension code.
